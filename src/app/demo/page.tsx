...
const COMPANIES: DemoCompany[] = [
  {
    ...
    totalRows: "~1,158",
    description:
      "Complete FinTech analytics stack: 500 transactions across 8 products, 200 customers across 5 plans (Standard to Business), 24-month P&L and KPIs with MAU/DAU/MRR trends, 200 KYC/AML compliance events, and 10 departmental cost centers. All data referentially consistent with realistic LTV, churn, and NPS metrics.",
    ...
    datasets: [
      ...
      "rev_pnl (24 rows)",
      "rev_products (8 rows)",
      "rev_compliance (200 rows)",
      "rev_cost_centers (10 rows)",
    ],
  },
  {
    id: "siemens",
    ...
    revenue: "~500M EUR (Division)",
    tables: 7,
    totalRows: "~1,178",
    description:
      "Enterprise industrial dataset: 400 orders across 3 BUs (Digital Industries, Smart Infrastructure, Mobility), 100 B2B customers (BMW, Deutsche Bahn, BASF...), 12-month P&L with EBIT and book-to-bill, 200 employees with utilization tracking, 80 named projects with risk scoring, 150 supply chain POs, and 48-row budget vs actual by BU.",
    color: "from-teal-500 to-emerald-600",
    gradient: "bg-gradient-to-br from-teal-500/10 to-emerald-600/10",
    datasets: [
      "si_orders (400 rows)",
      "si_customers (100 rows)",
      "si_pnl (12 rows)",
      "si_employees (200 rows)",
      "si_projects (80 rows)",
      "si_supply_chain (150 rows)",
      "si_budget_vs_actual (48 rows)",
    ],
  },
];
